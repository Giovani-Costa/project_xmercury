...
INSERT_PERICIAS_PERSONAGENS = "INSERT INTO pericias_personagens (id_pericia, id_personagem, nivel)"
INSERT_MODIFICADORES_SKILLS = (
...
INSERT_PARTY = "INSERT INTO party (id_party, nome)"
