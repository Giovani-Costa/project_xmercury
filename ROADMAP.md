    [x] Adicionar mais perícias -> adicionar mais perícias às já existentes, separar Preparo Físico em subdivisões focadas em cada força, destreza, constituição e iniciativa.
